...
const manageAir = function*(
  ...
  const airEntity = new Entity()
  airEntity.addComponent('Position', position)
  airEntity.addComponent('Air', new AirComponent(AirSystem.AIR_SHRINK_QUANTITY_THRESHOLD * 2))
